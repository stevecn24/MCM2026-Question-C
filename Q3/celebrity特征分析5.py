...
def create_output_directory():
    ...
    output_dir = "DWTS_RealFanVote_Analysis_Results"
...
def analyze_feature_impact(df, output_dir):
    ...
    impact_path = os.path.join(output_dir, 'data_exports', 'feature_impact_analysis.csv')
...
def create_feature_impact_visualizations(impact_df, output_dir):
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(output_dir, 'figures', 'impact_analysis', 'feature_impact_heatmaps.png'), 
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(output_dir, 'figures', 'impact_analysis', 'top_categories_radar.png'), 
               dpi=600, bbox_inches='tight')
    plt.close()
    ...
    if not industry_impact.empty:
        ...
        plt.tight_layout()
        plt.savefig(os.path.join(output_dir, 'figures', 'impact_analysis', 'industry_performance.png'), 
                   dpi=600, bbox_inches='tight')
        plt.close()
...
def create_judge_fan_alignment_analysis(df, output_dir):
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(output_dir, 'figures', 'impact_analysis', 'judge_fan_alignment.png'), 
               dpi=600, bbox_inches='tight')
    plt.close()
    ...
    alignment_path = os.path.join(output_dir, 'reports', 'judge_fan_alignment_stats.txt')
...
def create_regression_analysis(df, output_dir):
    ...
    correlation_path = os.path.join(output_dir, 'data_exports', 'feature_correlation_analysis.csv')
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(output_dir, 'figures', 'impact_analysis', 'feature_correlations.png'), 
               dpi=600, bbox_inches='tight')
    plt.close()
    ...
    with open(os.path.join(output_dir, 'reports', 'significant_correlations.txt'), 'w') as f:
        f.write("="*80 + "\n")
...
def create_radar_chart(df, output_dir):
    ...
    for industry in top_industries:
        ...
        plt.tight_layout()
        plt.savefig(os.path.join(output_dir, 'figures', 'radar_charts', f'radar_{industry.replace(" ", "_")}.png'), 
                   dpi=600, bbox_inches='tight')
        plt.close()
...
def create_heatmap_matrix(df, output_dir):
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(output_dir, 'figures', 'heatmaps', 'correlation_heatmap_fanvote.png'), 
               dpi=600, bbox_inches='tight')
    plt.close()
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(output_dir, 'figures', 'heatmaps', 'industry_heatmap_fanvote.png'), 
               dpi=600, bbox_inches='tight')
    plt.close()
...
def create_3d_scatter_plots(df, output_dir):
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(output_dir, 'figures', '3d_plots', '3d_scatter_real_fanvote.png'), 
               dpi=600, bbox_inches='tight')
    plt.close()
...
def create_time_series_analysis(df, output_dir):
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(output_dir, 'figures', 'time_series', 'performance_trends_fanvote.png'), 
               dpi=600, bbox_inches='tight')
    plt.close()
...
def create_summary_statistics(df, output_dir):
    ...
    summary_path = os.path.join(output_dir, 'reports', 'enhanced_summary_fanvote.txt')
    ...
    detailed_stats.to_csv(os.path.join(output_dir, 'data_exports', 'detailed_statistics_fanvote.csv'))
    
    # Save industry comparison
    industry_stats.to_csv(os.path.join(output_dir, 'data_exports', 'industry_comparison.csv'))
